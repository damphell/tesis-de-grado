...
(void) fprintf(stdout,
"Show server info:\n"
"Show info about smtp.gmail.com using STARTTLS\n"
" mailsend -info -port 587 -smtp smtp.gmail.com\n"
"Show inof about smtp.gmail.com, use SSL\n"
" mailsend -info -ssl -port 465 -smtp smtp.gmail.com\n");
(void) fprintf(stdout,
"**Please google for correct SMTP port for gmail for SSL and STARTTLS\n\n");
...
" -sub test +cc +bc -v -auth-plain\n"
" -user you -pass 'secert'\n\n");

    (void) fprintf(stdout,"SSL+AUTH LOGIN:\n");
(void) fprintf(stdout,
" mailsend -to user@gmail.com -from user@gmail.com\n"
" -ssl\n"
" -smtp smtp.gmail.com -port 465\n"
" -sub test +cc +bc -v -auth-login\n"
" -user you -pass 'secert'\n\n");
...
(void) fprintf(stdout,
" mailsend -f user@example.com -smtp 1.2.3.4\n"
" -sub test -to user@example.com +cc +bc -v -starttls -auth-cram-md5\n"
" -user you -pass 'secert'\n\n");

(void) fprintf(stdout,"STARTTLS+AUTH LOGIN:\n");
(void) fprintf(stdout,
" mailsend -f user@example.com -d example.com -smtp 1.2.3.4\n"
" -sub test -to user@example.com +cc +bc -v -starttls -auth-login\n"
" -user you -pass 'secert'\n");
(void) fprintf(stdout,
...
int main(int argc,char **argv)
{
            ...
            */
            ...
            case 's':
            {
                ...
                else if (strncmp("ssl", option + 1, 3) == 0)
                {
                    ...
                    g_do_ssl=1;
#else
                    (void) fprintf(stderr,"Warning: '-ssl' not available, not compiled with OpenSSL\n");
#endif /* HAVE_OPENSSL */
                ...
                else if (strncmp("starttls",option+1,3) == 0)
                {
                    ...
                    g_do_starttls=1;
#else
                    (void) fprintf(stderr,"Warning: '-starttls' not available, not compiled with OpenSSL\n");
    ...
    */
    ...
    if (rc == 0)
    {
        ...
        {
            //(void) initscr();
            //(void) printw("Secreto Enviado satisfactoriamente..\n");
            //(void) fflush(stdout);
            //(void) endwin();
        }
    }
